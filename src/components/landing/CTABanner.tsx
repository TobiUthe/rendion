...
export function CTABanner() {
  return (
    <section className="px-4 py-16 lg:px-8">
      <div className="mx-auto max-w-4xl rounded-xl border border-sand-200 bg-gradient-to-br from-sand-50 to-[var(--color-surface)] px-6 py-12 text-center shadow-sm sm:px-12 sm:py-14">
