        ...
        <div>
          ...
          >
            <input
              ...
              disabled
              className="w-full rounded-lg border border-sand-200 bg-sand-50 px-3 py-2 text-sm text-neutral-900 placeholder:text-neutral-400 disabled:cursor-not-allowed disabled:opacity-60"
