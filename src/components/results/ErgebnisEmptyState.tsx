    ...
    <PublicLayout width="full">
      <div className="container-lg page-px py-10">
        <div className="grid items-center gap-10 lg:grid-cols-[1fr_auto]">
          <div>
            <span className="inline-flex items-center gap-2 rounded-full border border-sand-200/80 bg-white/70 px-3 py-1 text-xs font-medium text-neutral-600 shadow-sm">
              Noch keine Analyse
            </span>
            <h1 className="mt-4 font-display text-3xl font-bold leading-tight tracking-[-0.02em] text-balance text-neutral-900 sm:text-4xl">
